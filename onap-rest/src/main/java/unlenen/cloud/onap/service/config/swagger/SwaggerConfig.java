 ...
 */
package unlenen.cloud.onap.service.config.swagger;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(getApiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("unlenen.cloud.onap.service"))
    ...
    private ApiInfo getApiInfo() {
        return new ApiInfo(
                ...
                new Contact("Nebi Volkan UNLENEN", "https://www.linkedin.com/in/nebi-volkan-unlenen-3143275/",
                        "unlenen@gmail.com"),
                "AGPL 3.0", "https://github.com/unlenen/onap-api/blob/master/LICENSE",
