...
public class RuntimeController {
    ...
    public ResponseEntity<String> getServiceInstances(@PathVariable(required = true) String customerId)
            throws Exception {
        return ResponseEntity.ok(runtimeController.getServiceInstances(customerId).toString());
    }
    ...
    public ResponseEntity<String> getServiceInstanceDetails(@PathVariable(required = true) String serviceInstanceId)
            throws Exception {
        return ResponseEntity.ok(runtimeController.getServiceInstanceDetails(serviceInstanceId).toString());
    }
    ...
    public ResponseEntity<String> createServiceInstance(@PathVariable String serviceInstanceName,
        ...
        return ResponseEntity.ok(runtimeController.createServiceInstance(serviceInstanceName, serviceModelInvariantUUID,
                serviceModelUUID, serviceName, owningId, owningName, customerId, projectName).toString());
    }
    ...
    public ResponseEntity<String> deleteServiceInstance(@PathVariable String serviceInstanceId,
            ...
            @RequestParam(name = "serviceInvariantUUID") String serviceModelInvariantUUID) throws Exception {
        return ResponseEntity.ok(runtimeController
                .deleteServiceInstance(serviceInstanceId, serviceName, serviceModelUUID, serviceModelInvariantUUID)
                .toString());
    }
    ...
    public ResponseEntity<String> getVNFs() throws Exception {
        return ResponseEntity.ok(runtimeController.getVNFs().toString());
    }
    ...
    public ResponseEntity<String> getActionStatus(@RequestParam("url") String url) {
        return ResponseEntity.ok(runtimeController.getActionStatus(url).toString());
    }
    ...
    public ResponseEntity<String> createVNF(@PathVariable String vnfName,
        ...
        return ResponseEntity.ok(runtimeController.createVNF(vnfName, serviceInstanceId, serviceName,
                serviceInvariantUUID, serviceUUID, serviceUniqueId, cloudOwner, cloudRegion, tenantId, vfName,
    ...
    public ResponseEntity<String> deleteVNF(@PathVariable String vnfId,
        ...
        return ResponseEntity.ok(runtimeController.deleteVNF(vnfId, serviceInstanceId, vfName, vfUUID, vfInvariantUUID,
                vfModelName, cloudOwner, cloudRegion, tenantId).toString());
    }
    ...
    public ResponseEntity<String> getVNFDetail(@PathVariable(required = true) String vnfId) throws Exception {
        return ResponseEntity.ok(runtimeController.getVNFDetail(vnfId).toString());
    }
    ...
    public ResponseEntity<String> getVNFDetailByService(
        ...
        return ResponseEntity.ok(runtimeController.getVNFDetailByService(serviceUniqueId, vnfName).toString());
    }
    ...
    public ResponseEntity<String> getVFModules(@PathVariable(required = true) String vnfId) throws Exception {
        return ResponseEntity.ok(runtimeController.getVFModules(vnfId).toString());
    }
    ...
    public ResponseEntity<String> preloadVFModule(
        ...
        return ResponseEntity.ok(runtimeController
                .preloadVFModule(vnfName, vnfType, vfModuleName, vfModuleType, availabilityZone, vFModuleProfile)
                .toString());
    }
    ...
    public ResponseEntity<String> createVfModule(
        ...
        return ResponseEntity.ok(runtimeController
                .createVfModule(vnfId, vfModuleName, serviceInstanceId, serviceName, serviceInvariantUUID, serviceUUID,
                        cloudOwner, cloudRegion, tenantId, vfUUID, vfName, vfModelUUID, vfModelType, vfModelName,
    ...
    public ResponseEntity<String> deleteVfModule(
            ...
            @RequestParam(name = "tenantId") String tenantId) throws Exception {
        return ResponseEntity.ok(runtimeController
                .deleteVfModule(vnfId, vfModuleId, serviceInstanceId, vfModelType, vfModelUUID, vfModelInvariantId,
